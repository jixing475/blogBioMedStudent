...
I am passionate about **applying Biostatistics and Machine Learning to Life Science Data**. I am exited about understanding the world through the data from any Biotech, Biomedicine or Biopharma area.
...
df <- data.frame(what = c('<i class="fab fa-twitter"></i>',
                 ...
                 where = c("[ZERO](https://twitter.com/ZERO98446206)",
                           "[Jixing](https://github.com/emitanaka)",
                           "[jixing475@163.com](mailto:jixing475@163.com)",
